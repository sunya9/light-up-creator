...
describe("illumination", () => {
  describe("getVisibleCells", () => {
    it("returns cells visible from a position in all 4 directions", () => {
      // 5x5 all white
  ...
  describe("getIlluminatedCells", () => {
    it("returns all cells illuminated by given bulbs", () => {
      const grid = parsePuzzle([".....", ".....", "..#..", ".....", "....."]);
    ...
    it("multiple bulbs combine illumination", () => {
      const grid = parsePuzzle(["...", "...", "..."]);
    ...
    it("black cells are never illuminated", () => {
      const grid = parsePuzzle([".#.", "...", "..."]);
      const bulbs = new Set(["0,0"]);
      const lit = getIlluminatedCells(grid, bulbs);
